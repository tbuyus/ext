function parseTextNodesUIfree(page,func,processAtWordLevel)
{
...
//           newnode.innerHTML="<TABLE ALIGN='CENTER' RULES='COLS' CELLSPACING='0' ><TR><TD>"+newText+"</TD><TD>"+oldText+"</TD></TR></TABLE>";} else
    ...
    //pnode.removeChild(node);
     var pnode=node.parentNode;
      ...
      // THIS MAYBE ENOUGH TO PLACATE REVIEWERS? THOUGH NO SPEED GAINS
...
//comment out last bit once it works                      
// THINK BELOW WAS TO DISABLE PROCESSING ONCE A SCHEME IS APPLIED
